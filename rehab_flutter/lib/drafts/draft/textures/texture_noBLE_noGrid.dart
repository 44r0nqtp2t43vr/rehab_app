          ...
          builder: (context, snapshot) {
            ...
            return Stack(
              children: <Widget>[
                ...
                RepaintBoundary(
                  key:
                      paintKey, // A unique identifier for this particular RepaintBoundary.
                  child: GestureDetector(
                    // GestureDetector is used to detect touch events on the child widget.
                    onPanDown: (details) => searchPixel(details
                        .globalPosition), // Handles the event when a touch is first detected.
                    onPanUpdate: (details) => searchPixel(details
                        .globalPosition), // Handles the event when an existing touch moves.
                    child: Center(
                      // Centers the child widget within the parent.
                      child: Image.asset(
                        imagePath, // Specifies the path to the image asset to be displayed.
                        key:
                            imageKey, // A unique identifier for this particular Image widget.
                      ),
                    ),
                  ),
                ),
                ...
                Positioned(
                  left:
                      20, // Positions the container 20 logical pixels from the left edge of the Stack.
                  bottom:
                      20, // Positions the container 20 logical pixels from the bottom edge of the Stack.
                  child: Container(
                    width:
                        50, // Sets the width of the container to 50 logical pixels.
                    height:
                        50, // Sets the height of the container to 50 logical pixels.
                    decoration: BoxDecoration(
                      shape: BoxShape.circle, // Makes the container circular.
                      color:
                          selectedColor, // Sets the background color of the container.
                      border: Border.all(
                          width: 2.0,
                          color: Colors
                              .white), // Adds a white border around the container.
                      boxShadow: [
                        BoxShadow(
                          color:
                              Colors.black12, // Shadow color with 12% opacity.
                          blurRadius:
                              4, // The amount of blur applied to the shadow.
