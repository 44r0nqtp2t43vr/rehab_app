...
class _ColorPickerWidgetState extends State<ColorPickerWidget> {
  ...
  // GlobalKey used for the repaint boundary, aiding in capturing the image for processing.
  GlobalKey paintKey = GlobalKey();
  // Determines whether to use a snapshot for picking colors or the image directly.
  bool useSnapshot = true;
  // Holds the current key in use, can be either `paintKey` or `imageKey` based on `useSnapshot`.
...
// BLUETOOTH THINGS
  // Instance of FlutterBlue for Bluetooth operations.
  // The target Bluetooth device to connect with.
  BluetoothDevice? targetDevice;
  // The characteristic of the Bluetooth device used for communication.
  BluetoothCharacteristic? targetCharacteristic;
  // The name of the target Bluetooth device.
  final String targetDeviceName = "Gloves_BLE_01";
  // Flag to indicate if the Bluetooth device is currently connected.
  bool isDeviceConnected = false;

  // Stores the last sent string to the gloves to avoid redundant sends.
