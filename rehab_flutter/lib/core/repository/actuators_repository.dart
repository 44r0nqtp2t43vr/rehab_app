...
class ActuatorsRepositoryImpl implements ActuatorsRepository {
  ...
  Future<void> initializeActuators(ActuatorsInitData initData) async {
    await _controller.initializeActuators(orientation: initData.orientation, numOfFingers: initData.numOfFingers, imgSrc: initData.imgSrc, photosHeight: initData.photosHeight, photosWidth: initData.photosWidth);
  }
