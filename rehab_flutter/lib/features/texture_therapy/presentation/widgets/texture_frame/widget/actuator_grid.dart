...
class ActuatorGrid {
  ...
  static int sumOfLeftActivatedActuators(
      List<Color> tappedColors, List<int> values) {
    int sum = 0;
  ...
  static int sumOfRightActivatedActuators(
      List<Color> tappedColors, List<int> values) {
    int sum = 0;
  ...
  static List<Widget> buildActuators(
      List<Offset> tapPositions, List<Color> tappedColors, List<int> values) {
