...
class TestingDataProvider {
  ...
  static final List<StaticPattern> twoPDPatterns = [
    StaticPattern(name: "1P, Left of Pinky", pattern: "032000", fingerNum: 0),
    StaticPattern(name: "2P, Left of Pinky", pattern: "040000", fingerNum: 0),
    StaticPattern(name: "1P, Right of Pinky", pattern: "000004", fingerNum: 0),
    StaticPattern(name: "2P, Right of Pinky", pattern: "000005", fingerNum: 0),
    StaticPattern(name: "1P, Left of Ring", pattern: "032000", fingerNum: 1),
    StaticPattern(name: "2P, Left of Ring", pattern: "040000", fingerNum: 1),
    StaticPattern(name: "1P, Right of Ring", pattern: "000004", fingerNum: 1),
    StaticPattern(name: "2P, Right of Ring", pattern: "000005", fingerNum: 1),
    StaticPattern(name: "1P, Left of Middle", pattern: "032000", fingerNum: 2),
    StaticPattern(name: "2P, Left of Middle", pattern: "040000", fingerNum: 2),
    StaticPattern(name: "1P, Right of Middle", pattern: "000004", fingerNum: 2),
    StaticPattern(name: "2P, Right of Middle", pattern: "000005", fingerNum: 2),
    StaticPattern(name: "1P, Left of Pointer", pattern: "032000", fingerNum: 3),
    StaticPattern(name: "2P, Left of Pointer", pattern: "040000", fingerNum: 3),
    StaticPattern(name: "1P, Right of Pointer", pattern: "000004", fingerNum: 3),
    StaticPattern(name: "2P, Right of Pointer", pattern: "000005", fingerNum: 3),
    StaticPattern(name: "1P, Left of Thumb", pattern: "032000", fingerNum: 4),
    StaticPattern(name: "2P, Left of Thumb", pattern: "040000", fingerNum: 4),
    StaticPattern(name: "1P, Right of Thumb", pattern: "000004", fingerNum: 4),
    StaticPattern(name: "2P, Right of Thumb", pattern: "000005", fingerNum: 4),
  ];
